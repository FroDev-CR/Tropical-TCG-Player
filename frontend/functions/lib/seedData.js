...
exports.verifyCollections = exports.createEmptyCollections = exports.seedStores = void 0;
const functions = require("firebase-functions");
const admin = require("firebase-admin");
// SPRINT 1 - FASE 1.2: Poblar colección stores con datos iniciales
exports.seedStores = functions.https.onCall(async (data, context) => {
    if (!context.auth) {
    ...
    try {
        ...
        for (const store of initialStores) {
            ...
            // Agregar timestamps
            const storeData = Object.assign(Object.assign({}, store), { createdAt: admin.firestore.FieldValue.serverTimestamp(), updatedAt: admin.firestore.FieldValue.serverTimestamp() });
...
exports.createEmptyCollections = functions.https.onCall(async (data, context) => {
    if (!context.auth) {
        throw new functions.https.HttpsError('unauthenticated', 'Usuario no autenticado');
    }
    try {
...
exports.verifyCollections = functions.https.onCall(async (data, context) => {
    if (!context.auth) {
        throw new functions.https.HttpsError('unauthenticated', 'Usuario no autenticado');
    }
    try {
